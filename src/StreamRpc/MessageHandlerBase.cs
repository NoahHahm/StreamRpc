...
namespace StreamRpc
{
    ...
    /// </remarks>
    public abstract class MessageHandlerBase : IJsonRpcMessageHandler, IHasIsDisposed
    {
        /// <summary>
        ...
        /// </summary>
        bool IHasIsDisposed.IsDisposed => this.DisposalToken.IsCancellationRequested;
