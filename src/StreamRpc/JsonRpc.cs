...
namespace StreamRpc
{
    ...
    /// </summary>
    public class JsonRpc : IHasIsDisposed
    {
        ...
        /// </summary>
        public ProxyGenerator ProxyGenerator { get; private set; } = new ProxyGenerator();
...
#pragma warning restore RS0027 // Public API with optional parameter(s) should have the most parameters amongst its public overloads.
        ...
        /// <summary>
        /// Creates a JSON-RPC client proxy instance that conforms to the specified server interface.
        /// </summary>
            ...
            where T : class
        {
            ...
            var proxyType = rpc.ProxyGenerator.Get(typeof(T).GetTypeInfo());
        ...
        public T Attach<T>(JsonRpcProxyOptions options)
            where T : class
        {
            var proxyType = ProxyGenerator.Get(typeof(T).GetTypeInfo());
        ...
        {
            var proxyType = ProxyGenerator.Get(type.GetTypeInfo());
        ...
        private JsonRpcMessage HandleInvocationTaskOfTResult(JsonRpcRequest request, Task t)
        {
            ...
            if (message is JsonRpcResult resultMessage)
            {
                ...
                Verify.Operation(TryGetTaskOfTOrValueTaskOfTType(t.GetType().GetTypeInfo(), out TypeInfo taskOfTTypeInfo));
                ...
                while (!this.IsDisposed && !this.DisconnectedToken.IsCancellationRequested)
                {
                    ...
                    catch (Exception exception)
                    {
                        this.OnJsonRpcDisconnected(new JsonRpcDisconnectedEventArgs(
                            ...
                            exception is InvalidCastException ? DisconnectedReason.ParseError : DisconnectedReason.StreamError,
                            exception));
                        return;
                    }
